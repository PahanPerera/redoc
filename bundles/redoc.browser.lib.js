          ...
          function R(e, t, r, n, i) {
            for (let s in e) {
              ...
              for (let e in a)
                if (g.httpMethods.indexOf(e) >= 0 || 'x-amazon-apigateway-any-method' === e) {
                  ...
                  if (p && p.parameters && Array.isArray(p.parameters)) {
                    ...
                    r.rbname && '' === p[r.rbname] && delete p[r.rbname],
                      r.debug || (p.parameters && (p.parameters = p.parameters.filter(C)));
                  }
              ...
              if (a && a.parameters) {
                ...
                !r.debug && Array.isArray(a.parameters) && (a.parameters = a.parameters.filter(C));
              }
            }
          }
          function L(e) {
        ...
        class W {
          ...
          constructor(e, t = {}) {
            ...
            (null == (r = e.theme) ? void 0 : r.menu) &&
              ...
              })(b({}, i, ((c = B({}, e.theme)), D(c, z({ extensionsHook: void 0 })))))),
...
`;
        ...
        var Ee = r(470),
          ...
          _e = (e, t) => {
            ...
            if (Pe) for (var r of Pe(t)) Ie.call(t, r) && Te(e, r, t[r]);
            return e;
          },
          Re = (e, t) => $e(e, Ce(t));
        function Le(e) {
        ...
        function De(e) {
          return 'default' === e || g(e) || Le(e);
        }
        function ze(e, t = !1) {
          if ('default' === e) return t ? 'error' : 'success';
          let r = 'string' == typeof e ? parseInt(e, 10) : e;
          if ((Le(e) && (r *= 100), r < 100 || r > 599)) throw new Error('invalid HTTP code');
          let n = 'success';
          return (
            r >= 300 && r < 400
              ? (n = 'redirect')
        ...
        const yt = e => ({ delete: 'del', options: 'opts' }[e] || e);
        function bt(e) {
          return (
            e in
            {
        ...
        var Pt = Object.defineProperty,
          ...
          Lt = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          Dt = (e, t) => {
            for (var r in t || (t = {})) _t.call(t, r) && Lt(e, r, t[r]);
            if (Tt) for (var r of Tt(t)) Rt.call(t, r) && Lt(e, r, t[r]);
            return e;
          },
          zt = (e, t) => At(e, It(t));
        const Nt = {};
          ...
          code(e) {
            ...
            if (t) {
              ...
              return {
                ...
                text: this.options.pedantic ? e : gr(e, '\n'),
              };
            }
          }
          fences(e) {
        ...
        var Ir = Object.defineProperty,
          ...
          Nr = (e, t) => {
            ...
            if (Rr) for (var r of Rr(t)) Dr.call(t, r) && zr(e, r, t[r]);
            return e;
          };
        ...
        var hn = Object.defineProperty,
          ...
          xn = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          vn = (e, t) => {
            for (var r in t || (t = {})) yn.call(t, r) && xn(e, r, t[r]);
            if (gn) for (var r of gn(t)) bn.call(t, r) && xn(e, r, t[r]);
            return e;
          },
          wn = (e, t) => mn(e, fn(t)),
          kn = (e, t) => {
            ...
            if (null != e && gn)
              for (var n of gn(e)) t.indexOf(n) < 0 && bn.call(e, n) && (r[n] = e[n]);
            return r;
          };
        function On(e, t) {
            ...
            if (
              ((this.oneOf = e.map((e, r) => {
                ...
                return new zn(
                  ...
                  Ln(Rn({}, i), {
                    title: s,
                    allOf: [Ln(Rn({}, this.schema), { oneOf: void 0, anyOf: void 0 })],
          ...
          let p = Object.keys(i || []).map(s => {
            ...
            return new Hn(
              e,
              {
                ...
                required: l,
                schema: Ln(Rn({}, a), { default: void 0 === a.default && c ? c[s] : a.default }),
              },
              r + '/properties/' + s,
              n,
              o,
        ...
        Dn([de.observable], Nn.prototype, 'activeOneOf', 2),
          Dn([de.action], Nn.prototype, 'activateOneOf', 1);
        const Fn = {};
        class Bn {
          constructor(e, t, r, n) {
            this.mime = r;
        ...
        class yo {
          ...
          get responses() {
            ...
            return Object.keys(this.operationSpec.responses || [])
              .filter(t => 'default' === t || ('success' === ze(t) && (e = !0), De(t)))
              .map(
                t =>
                  new po({
                    parser: this.parser,
        ...
        mo([de.observable], yo.prototype, 'ready', 2),
          mo([de.observable], yo.prototype, 'active', 2),
          mo([de.observable], yo.prototype, 'expanded', 2),
          mo([de.action], yo.prototype, 'activate', 1),
          mo([de.action], yo.prototype, 'deactivate', 1),
          mo([de.action], yo.prototype, 'toggle', 1),
          mo([Mt], yo.prototype, 'requestBody', 1),
          mo([Mt], yo.prototype, 'codeSamples', 1),
          mo([Mt], yo.prototype, 'parameters', 1),
          mo([Mt], yo.prototype, 'responses', 1),
          mo([Mt], yo.prototype, 'callbacks', 1);
          ...
          initWebhooks(e, t, r) {
            for (const o of Object.keys(t)) {
              ...
              for (const t of s) {
                ...
                if (!o) continue;
                const s = new yo(e, ((n = jo({}, o)), xo(n, vo({ httpVerb: t }))), void 0, r, !1);
        ...
        class ti {
                ...
                (t = this.flatItems.find(t => t.id === e)),
                  t
                    ...
                    : (e.startsWith(ft) &&
                        ...
                        this.activateAndScroll(t, !1)),
                      this.scroll.scrollIntoViewBySelector(`[${ei}="${C(e)}"]`));
              }),
          ...
          static updateOnHistory(e = Wt.currentId, t) {
            e && t.scrollIntoViewBySelector(`[${ei}="${C(e)}"]`);
          }
          subscribe() {
          ...
          getElementAt(e) {
            ...
            return (t && a(`[${ei}="${C(t.id)}"]`)) || null;
          }
          getElementAtOrFirstChild(e) {
            let t = this.flatItems[e];
            return (
              t && 'group' === t.type && (t = t.items[0]), (t && a(`[${ei}="${C(t.id)}"]`)) || null
            );
          }
          get activeItem() {
        ...
        var Es = Object.defineProperty,
          ...
          Cs = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          Ps = (e, t) => {
            for (var r in t || (t = {})) Ss.call(t, r) && Cs(e, r, t[r]);
            if (js) for (var r of js(t)) $s.call(t, r) && Cs(e, r, t[r]);
            return e;
          };
        const As = H()(t => e.createElement(Os, Ps({}, t)))`
  display: inline;
`;
        function Is(t) {
            ...
            return e.createElement(
              ...
              t &&
                e.createElement(
                  Rs,
                  null,
                  e.createElement(Ls, null, r),
                  e.createElement(Ds, null),
...
`;
        ...
        class Ca extends e.PureComponent {
          constructor() {
...
`;
        ...
        const La = e.memo(function ({ value: t, label: r, raw: n }) {
        ...
        function za(t) {
          ...
          return !r || n
            ...
            : e.createElement(
                e.Fragment,
                null,
                e.createElement(wa, null, o || r.length < Da ? r : `${r.substr(0, Da)}...`),
                r.length > Da &&
        ...
        function Na({ schema: t }) {
          ...
          return t &&
            ...
            ? e.createElement(
                ...
                null,
                '[ items',
                t.displayFormat && e.createElement(ya, null, ' <', t.displayFormat, ' >'),
...
`;
        ...
        const Va = (0, ua.observer)(t => {
            const { enumSkipQuotes: r, hideSchemaTitles: n } = e.useContext(ce),
              ...
              g = x(a.default) ? Xe(i, a.default).replace(`${i.name}=`, '') : a.default;
            return e.createElement(
              'div',
              null,
              e.createElement(
                ...
                a.displayFormat && e.createElement(ya, null, ' ', '<', a.displayFormat, '>', ' '),
                a.contentEncoding &&
                  e.createElement(ya, null, ' ', '<', a.contentEncoding, '>', ' '),
                a.contentMediaType &&
                  e.createElement(ya, null, ' ', '<', a.contentMediaType, '>', ' '),
                a.title && !n && e.createElement(ga, null, ' (', a.title, ') '),
              ...
              c &&
                e.createElement(
                  'div',
                  null,
                  e.createElement(Pi, { type: 'warning' }, ' ', _('deprecated'), ' '),
                ),
              e.createElement(La, { raw: m, label: _('default') + ':', value: g }),
              !s && e.createElement(Ca, { isArrayType: h, values: a.enum }),
              ' ',
              f,
              ...
              (s && s(t)) || null,
              (d && e.createElement(La, { label: _('const') + ':', value: d })) || null,
            );
          }),
          Ha = e.memo(Va);
              ...
              d = c
                ? e.createElement(
                    ...
                    e.createElement(
                      ...
                      e.createElement(Ci, { direction: p ? 'down' : 'right' }),
                    ),
                    u,
                  )
                : e.createElement(
...
`;
            ...
            return e.createElement(
              ...
              e.createElement(
                ...
                t[r.activeOneOf].deprecated &&
                  e.createElement(Pi, { type: 'warning' }, 'Deprecated'),
              ),
              ...
              e.createElement(
                ...
                ((o = ((e, t) => {
                  ...
                  if (yl) for (var r of yl(t)) xl.call(t, r) && vl(e, r, t[r]);
                  return e;
                })({}, this.props)),
                ml(o, gl({ schema: n }))),
              ),
        ...
        const El = (0, ua.observer)(({ schema: t }) =>
          e.createElement(
            ...
            t.title && e.createElement(ga, null, ' ', t.title, ' '),
        ...
        var jl = Object.defineProperty,
          ...
          Il = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          Tl = (e, t) => {
            for (var r in t || (t = {})) Pl.call(t, r) && Il(e, r, t[r]);
            if (Cl) for (var r of Cl(t)) Al.call(t, r) && Il(e, r, t[r]);
            return e;
          },
          _l = (e, t) => Sl(e, $l(t));
          ...
          render() {
            ...
            const r = this.props,
              ...
              o = ((e, t) => {
                ...
                if (null != e && Cl)
                  for (var n of Cl(e)) t.indexOf(n) < 0 && Al.call(e, n) && (r[n] = e[n]);
                return r;
              })(r, ['schema']),
              i = (o.level || 0) + 1;
        ...
        class cc {
          constructor(e, t, r = {}, n = !0) {
            (this.marker = new Ht()),
              ...
              (this.spec = new Lo(e, t, this.options)),
        ...
        let vc = class extends e.Component {
          render() {
            ...
            const n = r.href || (t.contact && t.contact.url),
              ...
              i = e.createElement(yc, { src: r.url, alt: o });
            return e.createElement(
              bc,
...
`,
  ...
  `,
          ...
          Lc = ee.label.attrs(e => ({ className: Pc()('-depth' + e.depth, { active: e.active }) }))`
  cursor: pointer;
...
`,
          Fc = ee(t => {
            ...
            return e.createElement(
              ...
              e.createElement(qc, { type: s }, yt(s)),
              e.createElement(Ci, {
                size: '1.5em',
              ...
              a ? e.createElement(Pi, { type: 'warning' }, ' ', _('deprecated'), ' ') : null,
            );
          })`
  padding: 10px;
  border-radius: 2px;
          ...
          render() {
            ...
            return r && r.length
              ? e.createElement(
                  'div',
                  { key: t },
                  e.createElement(yi, null, t, ' Parameters'),
                  e.createElement(
                    Ni,
                    null,
                    e.createElement(
          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(Ci, { size: '1.3em', direction: o ? 'down' : 'right' }),
              ),
              e.createElement(
                Jl,
                { expanded: o },
            ...
            return (
              (r.length > 0 &&
                e.createElement(
                  'div',
                  null,
                  e.createElement(gi, null, ' ', _('responseSamples'), ' '),
                  e.createElement(
                    Wi,
                    { defaultIndex: 0 },
                    e.createElement(
